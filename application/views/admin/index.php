...
<head>
	...
	<link rel="shortcut icon" href="../assets/img/Log.jpg">
	...
	<link rel="stylesheet" href="../assets/css/tabla/dataTables.bootstrap4.min.css">
...
<body>
						...
						<div class="col-md-12">
							<div class="content-panel position-abs">
								...
								<table id="tablax" class="table table-striped table-bordered" style="width:100%">
									...
									<thead class="theadver">
										<tr>
											<th><i class="fa fa-bullhorn"></i> Clientes</th>
											<th class="hidden-phone"><i class="fa fa-edit"></i> Estado Cliente</th>
									...
									<tbody>
										<tr>
											<td>Cliente 1</td>
											<td class="hidden-phone"><span class="label label-warning label-mini">En progreso</span></td>
											<td>Etapa 1</td>
											<td>
										...
										<tr>
											<td>Cliente 7</td>
											<td class="hidden-phone"><span class="label label-success label-mini ">Terminado</span></td>
											<td>Etapa 1</td>
											<td>
												<button data-target="#myModal" data-toggle="modal" class="btn btn-success btn-xs fa fa-check"></button>
												<button data-target="#update" data-toggle="modal" class="btn btn-primary btn-xs fa fa-pencil"></button>
	...
	<script src="../assets/js/dattable.js"></script>
