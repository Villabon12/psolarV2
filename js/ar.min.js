...
var verlay = document.getElementById('sliders'),
	btnccc = document.getElementById('bcerrar');

	btnccc.addEventListener('click', function(e){
	e.preventDefault();
	verlay.classList.remove('active');
...
$(document).ready(function(){
    ...
    $('#adlateral').css('position', 'absolute');
    }
