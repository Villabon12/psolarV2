...
<head>
    ...
    <link href="<?=base_url()?>css/style3.css" rel="stylesheet">
    <script src="<?=base_url()?>js/main.04e442bc.js"></script>
                ...
                <div class="di08yh36">
                  <div class="sRO_90R7">
                    <div role="button" tabindex="0">
                      <div class="oa2kg82w">
                        <a href="index.php"><img src="<?=base_url()?>Img/loimg.png"></a>
                      </div>
                    </div><a class="m1NFK7ma " href="#porque">Por Qué IRSE Solar</a>
                    <div class="eICEZf60"><button type="button" class="ant-btn ant-btn-primary esti" onclick="window.location='login.html'"><span>Estimados gratis</span></button></div>
                    <a class="m1NFK7ma " href="#referidor">Referidor</a>
                    <a class="m1NFK7ma " href="">Quiero saber mas</a>
                    <div class="RznqkN5Y"><a href="tel:8339576527">Tel: 8339576527</a></div>
                  </div>
                  <div class="eICEZf60"><button type="button" class="ant-btn ant-btn-primary LgWjiDsv"><span>Iniciar Sesion</span></button></div>
                </div>
              </header>
            <div class="ant-row zQm1JIWJ">
                <div class="nHX3YbVZ"></div>
                <div class="n2HZemBK"><span class="KCC7Ij2N">Conviértete en un Referidor Solar</span><span
                        class="VsVLzfT_">¡¡¡Sabias que tu referencia es muy importante para nosotros!!! Por medio de ti llegamos a más personas 
                        haciendo un impacto más fuerte no solo ayudándote a reducir tus facturas eléctricas si no que ayudamos a reducir la 
                        contaminación al medio ambiente.</span><button type="button" onclick="window.location='RegRefe.html'"
                        class="ant-btn ant-btn-primary ant-btn-block MDrznqEj"><span>Registro gratuito</span></button>
                </div>
            </div>
    ...
    <div class="ant-modal-root">
        ...
        <div tabindex="-1" class="ant-modal-wrap" role="dialog" aria-labelledby="rcDialogTitle0" >
            <div role="document" class="ant-modal pIijSD97" style="width: 520px; transform-origin: 365px 415px;">
                ...
                <div class="ant-modal-content"><a href="<?=base_url()?>" type="button" aria-label="Close" class="ant-modal-close"><span
                            class="ant-modal-close-x"><span role="img" aria-label="close" class="anticon anticon-close"
                                style="color: white;"><svg viewBox="64 64 896 896" focusable="false" data-icon="close"
                    ...
                    <div class="ant-modal-header">
                        <div class="ant-modal-title" id="rcDialogTitle0">
                            <div class="QO4GMxWk"><span class="k2z825MI"> LOYOLA </span>
                                <p class="nmakZkO0">Refiere y gana por comprartir</p>
                            </div>
                        </div>
                    </div>
                    <div class="ant-modal-body">
                        <div class="d1EZtXp9">
                            <div class="rWZYvJke">Tu Información</div>
                            <div class="EEb0Gmik"></div>
                        </div>
                        <form action="<?=base_url()?>index.php/Inicio/insertar_refer" class="ant-form ant-form-horizontal Czk1txKg" method="POST">
                            <span class="ULaXP8pY">Nombre</span>
                            <div class="ant-row ant-form-item">
                                <div class="ant-col ant-form-item-control">
                                    <div class="ant-form-item-control-input">
                                        <div class="ant-form-item-control-input-content"><input
                                                class="ant-input ant-input-lg P7gqZmjp" name="nombre" type="text"
                                                id="nombre" required autofocus></div>
                                    </div>
                                </div>
                            </div>
                            <span class="ULaXP8pY">Apellido</span>
                            <div class="ant-row ant-form-item">
                                <div class="ant-col ant-form-item-control">
                                    <div class="ant-form-item-control-input">
                                        <div class="ant-form-item-control-input-content"><input
                                                class="ant-input ant-input-lg P7gqZmjp" name="apellido" type="text"
                                                id="apellido" autofocus></div>
                                    </div>
                                </div>
                            </div>
                            <span class="ULaXP8pY">Email</span>
                            <div class="ant-row ant-form-item">
                                <div class="ant-col ant-form-item-control">
                                    <div class="ant-form-item-control-input">
                                        <div class="ant-form-item-control-input-content"><span
                                                class="ant-input-group-wrapper ant-input-group-wrapper-lg aoZt95vE"><span
                                                    class="ant-input-wrapper ant-input-group"><span
                                                        class="ant-input-group-addon">
                                                        <div class="gAodyF6E"><span role="img" aria-label="mail"
                                                                class="anticon anticon-mail"
                                                                style="color: rgb(199, 217, 224); font-size: 17px;"><svg
                                                                    viewBox="64 64 896 896" focusable="false"
                                                                    data-icon="mail" width="1em" height="1em"
                                                                    fill="currentColor" aria-hidden="true">
                                                                    <path
                                                                        d="M928 160H96c-17.7 0-32 14.3-32 32v640c0 17.7 14.3 32 32 32h832c17.7 0 32-14.3 32-32V192c0-17.7-14.3-32-32-32zm-40 110.8V792H136V270.8l-27.6-21.5 39.3-50.5 42.8 33.3h643.1l42.8-33.3 39.3 50.5-27.7 21.5zM833.6 232L512 482 190.4 232l-42.8-33.3-39.3 50.5 27.6 21.5 341.6 265.6a55.99 55.99 0 0068.7 0L888 270.8l27.6-21.5-39.3-50.5-42.7 33.2z">
                                                                    </path>
                                                                </svg></span></div>
                                                    </span><input class="ant-input ant-input-lg" name="email"
                                                        type="text" id="email" autofocus></span></span></div>
                                    </div>
                                </div>
                            </div>
                            
                            <span class="ULaXP8pY">Teléfono</span>
                            <div class="ant-row ant-form-item">
                                <div class="ant-col ant-form-item-control">
                                    <div class="ant-form-item-control-input">
                                        <div class="ant-form-item-control-input-content"><span
                                                class="ant-input-group-wrapper ant-input-group-wrapper-lg aoZt95vE"><span
                                                    class="ant-input-wrapper ant-input-group"><span
                                                        class="ant-input-group-addon">
                                                        <div class="gAodyF6E"><svg width="18" height="18"
                                                    ...
                                                    </span><input class="ant-input ant-input-lg" name="telefono"
                                                        type="text" id="telefono" autofocus></span></span></div>
                                    </div>
                                </div>       
                            </div>
                            ...
                            <div class="E82d6aoE"><button type="submit"
                                    class="ant-btn ant-btn-default Lj9QbRop"><span>Unirse</span></a><button
                                    type="button" class="ant-btn ant-btn-default hS3Wz8zp"><span>Cancelar</span></button>
                            </div>
                        </form>
                    </div>
                </div>
