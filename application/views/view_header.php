    ...
    <div class="ant-modal-root">
              ...
              <div class="ant-modal-content">
                ...
                <div class="ant-modal-body">
                  <form class="ant-form ant-form-horizontal Czk1txKg">
                    <span class="ULaXP8pY">Escribir Codigo Postal</span>
                    <div class="ant-row ant-form-item">
                      <div class="ant-col ant-form-item-control">
                        <div class="ant-form-item-control-input">
                          <div class="ant-form-item-control-input-content"><input
                              class="ant-input ant-input-lg P7gqZmjp" name="nal" type="text" id="nal" value=""></div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="botonera">
                    ...
                    <input type="submit" value="Confirmar" name="confirmar" id="i_confb" class="boton">
          ...
          <div tabindex="-1" class="att" id="att" role="dialog" aria-labelledby="rcDialogTitle0" >
            <div role="document" class="ant-modal pIijSD97" style="width: 520px; transform-origin: 365px 415px;">
              ...
              <div class="ant-modal-content">
                <a id="btn-cerrar-popup" href="<?=base_url()?>index.php" type="button" aria-label="Close"
                  class="ant-modal-close"><span class="ant-modal-close-x"><span role="img" aria-label="close"
                      class="anticon anticon-close" style="color: white;"><svg viewBox="64 64 896 896" focusable="false"
                        data-icon="close" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                        <path
          ...
          <div class="ant-modal-root">
            ...
            <div tabindex="-1" class="att" id="ass" role="dialog" aria-labelledby="rcDialogTitle0">
              <div role="document" class="ant-modal pIijSD97" style="width: 520px; transform-origin: 365px 415px;">
                ...
                <div class="ant-modal-content">
                  <button id="btn-cerrarr" onclick="window.location='index.php'" type="button" aria-label="Close"
                  class="ant-modal-close"><span class="ant-modal-close-x"><span role="img" aria-label="close"
                  class="anticon anticon-close" style="color: white;"><svg viewBox="64 64 896 896" focusable="false"
                  data-icon="close" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                  <path
            ...
            <div class="ant-modal-body">
              <form id="quote" class="ant-form ant-form-horizontal gLwQYxW6">
                
                <div class="ant-modal-body">
                  <div class="d1EZtXp9">
                    <div class="WsMtvfgp"><span class="_rQ8jXtd">1</span></div>
                    <div class="ant-row pzH0oHdB"><span class="rWZYvJke">¿A cuánto asciende tu factura de luz
                      TÍPICA?</span></div>
                      <div class="quantity">
                      ...
                      <div class="BWIitdyC">
                        ...
                        <div class="ant-row ant-form-item">
                          <div class="ant-col ant-form-item-control">
                            <div class="ant-form-item-control-input">
                              <div class="ant-form-item-control-input-content"><input
                              class="ant-input ant-input-lg X6bvyjWl" name="firstName" id="quote_firstName"
                              type="text" value=""></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="BWIitdyC">
                        ...
                        <div class="ant-row ant-form-item">
                          <div class="ant-col ant-form-item-control">
                            <div class="ant-form-item-control-input">
                                <div class="ant-form-item-control-input-content"><input
                                class="ant-input ant-input-lg X6bvyjWl" name="lastName" id="quote_lastName"
                                type="text" value=""></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="BWIitdyC">
                          ...
                          <div class="ant-row ant-form-item">
                            <div class="ant-col ant-form-item-control">
                              <div class="ant-form-item-control-input">
                                <div class="ant-form-item-control-input-content"><input
                                class="ant-input ant-input-lg X6bvyjWl" name="street" id="quote_street" type="text"
                                value=""></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="BWIitdyC">
                          ...
                          <div class="ant-row ant-form-item">
                            <div class="ant-col ant-form-item-control">
                              <div class="ant-form-item-control-input">
                                <div class="ant-form-item-control-input-content"><input
                                class="ant-input ant-input-lg X6bvyjWl" name="city" id="quote_city" type="text"
                                    value=""></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="BWIitdyC">
                          ...
                          <div class="ant-row ant-form-item">
                            <div class="ant-col ant-form-item-control">
                              <div class="ant-form-item-control-input">
                                <div class="ant-form-item-control-input-content"><input
                                class="ant-input ant-input-lg X6bvyjWl" name="state" id="quote_state" type="text"
                                value=""></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="BWIitdyC">
                          ...
                          <div class="ant-row ant-form-item">
                            <div class="ant-col ant-form-item-control">
                              <div class="ant-form-item-control-input">
                                <div class="ant-form-item-control-input-content"><input
                                class="ant-input ant-input-lg X6bvyjWl" name="zip" id="quote_zip" type="text"
                                value=""></div>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="ant-form-item-control-input">
                                ...
                                class="ant-input-wrapper ant-input-group"><span class="ant-input-group-addon">
                                  ...
                                  <path
                                          ...
                                          </span><input class="ant-input ant-input-lg" name="phone" id="quote_phone"
